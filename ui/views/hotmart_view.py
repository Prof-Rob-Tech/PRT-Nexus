...
from services.extractors.hotmart_connector import HotmartWorker


class HotmartView(QWidget):
    ...
    def _montar_interface(self):
        ...
        lbl_titulo = QLabel("Conector Hotmart")
        ...
        # 1. Captura de Mídia
        gb_captura = QGroupBox("🔗 Captura de Mídia - Hotmart")
        ly_captura = QVBoxLayout(gb_captura)
        ly_captura.setContentsMargins(10, 10, 10, 10)
        ly_captura.setSpacing(8)

        self.txt_url = QLineEdit()
        self.txt_url.setPlaceholderText("Cole o link do curso na área de membros...")
        ...
        self.txt_aula.setPlaceholderText("Nome da aula, como aparece no menu")
        ...
        self.btn_avulso.setStyleSheet("background-color: #FF3E00; color: white; font-weight: bold; padding: 8px; border-radius: 8px; border: none;")
        ...
        self.txt_email.setPlaceholderText("digite seu e-mail da Hotmart")
        ...
        self.txt_nome_conteudo.setPlaceholderText("Vazio usa o nome do curso na Hotmart")
        ...
        lbl_tab_title = QLabel("📦 Mídias do Hotmart (Duplo clique para abrir a pasta)")
    ...
    def _iniciar_download(self, modo_avulso):
        ...
        self.worker = HotmartWorker(url, email, senha, destino, modo_avulso=modo_avulso, opcoes=opcoes)
    ...
    def _on_concluido(self, sucesso, mensagem):
        ...
        if sucesso:
            QMessageBox.information(self, "Hotmart", mensagem)
        else:
            QMessageBox.critical(self, "Hotmart - Erro", mensagem)
