...
from services.extractors.vimeo_connector import VimeoWorker, separar_links


class VimeoView(QWidget):
    ...
    def _montar_interface(self):
        ...
        lbl_titulo = QLabel("Conector Vimeo")
        lbl_titulo.setStyleSheet("font-size: 24px; font-weight: bold; color: #ffffff;")
        lbl_sub = QLabel("Cole um ou mais links, um por linha. Vídeo, player ou showcase entram na mesma fila.")
        ...
        gb_captura = QGroupBox("🔗 Links do Vimeo")
        ...
        self.btn_baixar.setStyleSheet(
            "background-color: #1AB7EA; color: #062027; font-weight: bold; padding: 8px; border-radius: 8px; border: none;"
        )
        ...
        self.txt_nome_conteudo.setPlaceholderText("Vazio usa o título do Vimeo. Com vários links, cada um fica na própria pasta.")
        ...
        ly_prog = QHBoxLayout()
        self.lbl_status_global = QLabel("Aguardando link do Vimeo...")
        ...
        self.pbar_global.setStyleSheet("""
            ...
            QProgressBar::chunk { background-color: #1AB7EA; border-radius: 6px; }
        """)
        ...
        lbl_tab = QLabel("📦 Vídeos do Vimeo (duplo clique abre a pasta)")
    ...
    def _iniciar_download(self):
        ...
        if not links:
            QMessageBox.warning(self, "Link vazio", "Cole um ou mais links do Vimeo, um por linha.")
            return
        self.txt_destino.deselect()
        ...
        self.worker = VimeoWorker("", destino, opcoes=opcoes, urls=links)
    ...
    def _on_concluido(self, sucesso, mensagem):
        ...
        if self.chk_notif.isChecked():
            ...
            QApplication.beep()
        if sucesso:
            QMessageBox.information(self, "Vimeo", mensagem)
        else:
            QMessageBox.critical(self, "Vimeo", mensagem)
