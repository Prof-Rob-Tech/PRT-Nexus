...
class MegaView(QWidget):
    ...
    def _montar_interface(self):
        ...
        ly_prog = QHBoxLayout()
        self.lbl_status_global = QLabel("Aguardando link do Mega...")
        ...
        self.pbar_global.setStyleSheet("""
            ...
            QProgressBar::chunk { background-color: #D9272E; border-radius: 6px; }
        """)
        ...
        lbl_tab = QLabel("📦 Arquivos do Mega (duplo clique abre a pasta)")
    ...
    def _on_concluido(self, sucesso, mensagem):
        ...
        if self.chk_notif.isChecked():
            ...
            QApplication.beep()
        if sucesso:
            QMessageBox.information(self, "Mega", mensagem)
        else:
            QMessageBox.critical(self, "Mega", mensagem)
