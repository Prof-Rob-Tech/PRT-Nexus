...
SVG_ICONS = {
    ...
    "greenn": """<svg viewBox="0 0 64 76" fill="none"><defs><linearGradient id="greennIcon" x1="8" y1="4" x2="56" y2="70" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#D4F562"/><stop offset="0.5" stop-color="#2FDB8A"/><stop offset="1" stop-color="#14C6DE"/></linearGradient></defs><circle cx="32" cy="30" r="19" stroke="url(#greennIcon)" stroke-width="9"/><path fill="url(#greennIcon)" d="M25 47h14l-7 16z"/><path d="M21 31l8 8 15-16" stroke="url(#greennIcon)" stroke-width="5.4" stroke-linecap="round" stroke-linejoin="round"/></svg>""",
